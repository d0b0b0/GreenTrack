    ...
    <section className="section">
      <div className="container">
        <div className="section-head">
          ...
          <h2>Розрахуйте свій річний вуглецевий слід</h2>
              ...
              <div className="mt-3">
                {authed ? (
                  ...
                  <div className="alert info">
                    <span>
                      🔒 Зареєструйтесь, щоб зберегти результат, відстежувати прогрес і отримати персональні поради.{' '}
